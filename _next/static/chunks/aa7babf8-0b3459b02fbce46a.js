"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[67],{2080:function(e,t,i){i.d(t,{C:function(){return e7},ab:function(){return e8},o:function(){return ir},y:function(){return e5}});var r,n=i(4496),s=i(3943),a=i(2879),o=i(160),l=i(6880);function c(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let u=new s.LL("auth","Firebase",c()),h=new a.Yd("@firebase/auth");function d(e,...t){h.logLevel<=a.in.ERROR&&h.error(`Auth (${n.Jn}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e6(e){let t=ey(e);t._getPasswordPolicyInternal()&&await t._updatePasswordPolicy()}function e8(e,t,i){return(0,n.rh)(e.app)?Promise.reject(g(e)):e9((0,s.m9)(e),eq.credential(t,i)).catch(async t=>{throw"auth/password-does-not-meet-requirements"===t.code&&e6(e),t})}function e5(e,t,i,r){return(0,s.m9)(e).onAuthStateChanged(t,i,r)}function e7(e){return(0,s.m9)(e).signOut()}new WeakMap;let te="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}(r)),(0,n.KN)(t8,t5,"esm2017")}}]);